#! /usr/bin/env python3
# -*- coding: utf-8 -*-
# filename: rename2-and-clean-fname.py
# ---
...
# USAGE
my_usage = '''
		Usage: rename2_and_clean_fname.py [filename]

		[filename]	  existing filename
        
        ### Description:
        ### Creates backup of original file, replaces spaces and
        ### special characters with underscore, and converts all
...
# MAIN
print("[ {} ] -- ".format(tms()) + "Started: {}".format(sys.argv[0]))
