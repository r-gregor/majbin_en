...
tms; echo "Converting ..."
# enscript -v -f "IosevkaNerdFontMono8" -F "IosevkaNerdFontMono8" --header='$n||Page $% of $=' -p ${FJLPS} ${FJL} 2> info2
enscript -v -T 4 -f "Consolas8" -F "Consolas8" --header='$n||Page $% of $=' -p ${FJLPS} ${FJL} 2> info2
